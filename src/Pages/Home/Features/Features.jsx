...
>
  ...
  <div className="relative group w-80 h-52 [perspective:1200px]">
    ...
    >
      ...
      <h1 className="text-4xl font-extrabold drop-shadow-md">{allCarts.length}</h1>
      <h1 className="text-lg font-medium opacity-90">Number of Parcel Booked</h1>
    </div>
  </div>
  ...
  <div className="relative group w-80 h-52 [perspective:1200px]">
    ...
    >
      ...
      <h1 className="text-4xl font-extrabold drop-shadow-md">{allDelivery.length}</h1>
      <h1 className="text-lg font-medium opacity-90">Number of Parcel Delivered</h1>
    </div>
  </div>
  ...
  <div className="relative group w-80 h-52 [perspective:1200px]">
    ...
    >
      ...
      <h1 className="text-4xl font-extrabold drop-shadow-md">{users.length}</h1>
      <h1 className="text-lg font-medium opacity-90">Number of People Using Your App</h1>
    </div>
  </div>
</div>
    </div>
