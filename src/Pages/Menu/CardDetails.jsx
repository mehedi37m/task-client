              ...
              <div className="space-y-5">
                <div className="form-control">
                  ...
                  <input
                    type="email"
                    defaultValue={email}
                    className="input input-bordered w-full text-white rounded-xl shadow-md"
                    required
                  />
                </div>
                <div className="form-control">
              ...
              <div className="space-y-5">
                ...
                <div className="flex justify-center">
                  <div className="border">
                    <button
                      className="px-4 w-[50px] font-bold font_standard my-1.5"
                  ...
                  <div className="border-y">
                    <input
                      type="number"
                      className="font-bold w-[50px] lg:w-[60px] font_standard px-2 text-center mx-auto h-full"
                      value={quantity}
                      readOnly
                    />
                  </div>
